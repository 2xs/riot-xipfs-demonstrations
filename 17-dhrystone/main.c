...
int main(int argc, const char *argv[]) {
    ...
    Number_Of_Runs = (unsigned)strtol(argv[1], &endptr, 10);
    ...
    /* Initializations */
    Next_Ptr_Glob = (Rec_Pointer) &Rec_Glob;
    Ptr_Glob = (Rec_Pointer)&Next_Rec_Glob;
